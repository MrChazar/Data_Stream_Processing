...
f_sin_def, Pxx_den_sin_def = ex2.psd(y_sin, fs)
f_square_def, Pxx_den_square_def = ex2.psd(y_square, fs)
f_sawtooth_def, Pxx_den_sawtooth_def = ex2.psd(y_sawtooth, fs)
f_chirp_def, Pxx_den_chirp_def = ex2.psd(y_chirp, fs)
f_super_position_def, Pxx_den_super_position_def = ex2.psd(y_super_position, fs)
f_impulse_def, Pxx_den_impulse_def = ex2.psd(y_impulse, fs)
